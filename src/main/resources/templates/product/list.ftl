        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <tr class="success">
                    ...
                    <td>
                        <a href="/sell/seller/product/index?orderId=${product.productId}">修改</a>
                    </td>
                    <td>
                    <#if product.getProductStatusEnum().message=="在架">
                        <a href="/sell/seller/product/off_sale?orderId=${product.productId}">下架</a>
                    <#else>
                               <a href="/sell/seller/product/on_sale?orderId=${product.productId}">上架</a>
                    </#if>
                    </td>
                </tr>
                </#list>
